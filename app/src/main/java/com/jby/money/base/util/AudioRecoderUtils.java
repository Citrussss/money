...
public class AudioRecoderUtils {
    ...
    public void startRecord() {
        ...
        try {
            ...
            updateMicStatus();
            Timber.e("fan,startTime:%1d" ,(int)startTime);
        } catch (IllegalStateException e) {
            Timber.i(TAG+ "call startAmr(File mRecAudioFile) failed!" + e.getMessage());
        } catch (IOException e) {
            Timber.i(TAG+ "call startAmr(File mRecAudioFile) failed!" + e.getMessage());
        }
    }
    ...
    public long stopRecord() {
        ...
        Timber.e("fan,startTime:%1d" ,(int)endTime - startTime);
